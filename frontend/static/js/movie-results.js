        ...
        success: function (response) {
            ...
            if (response.Response === "True") {
                ...
                for (var i = 1; i <= totalPages; i++) {
                    var pageUrl = fullUrl + "&page=" + i;

                    $.ajax({
                        url: pageUrl,
                        type: "GET",
                        success: function (pageResponse) {
                            var movies = pageResponse.Search;
                                    ...
                                    <div class="movie-card">
                                        ...
                                        <div class="content">
                                            ...
                                            ${movie.Title.replace(new RegExp(searchQuery, "gi"), "<span class='high-light'>$&</span>")} (${movie.Year})
                                             ...
                                             <div class="rate-wrap">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="99.992" height="100" viewBox="0 0 99.992 100" class="icon-start">
